...
const gameList = [
	{
		'id': 0,
		'name': 'Mumble',
		'feedUrl': 'https://github.com/SpawnHouse/MumblePortable/releases/latest/download/Mumble.zip',
		'customParams' : {
	...
	},
	{
		'id': 1,
		'name': 'Minecraft',
		'feedUrl': 'https://github.com/SpawnHouse/Minecraft/releases/latest/download/Minecraft.zip',
		'customParams': {
	...
	},
	{
		'id': 2,
		'name': 'Valheim',
		'feedUrl': 'https://github.com/SpawnHouse/Valheim-ModPack/releases/latest/download/Valheim.zip',
		'customParams': {
...
function isMinecraftInstalled() {
	if(fs.existsSync(gameList[1].customParams.minecraftPath + '/mods/mumblelink.jar')
